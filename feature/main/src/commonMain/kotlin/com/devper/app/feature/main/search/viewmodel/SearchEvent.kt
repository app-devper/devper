...
sealed class SearchEvent {
    ...
    data class OnUpdateSelectedSort(
        val value: Int,
    ) : SearchEvent()

    data class OnUpdatePriceRange(
    ...
    data class OnUpdateSearchText(
        val value: String,
    ) : SearchEvent()

    data class OnUpdateSortDialogState(
        val value: UIComponentState,
    ) : SearchEvent()

    data class OnUpdateFilterDialogState(
        val value: UIComponentState,
    ) : SearchEvent()
