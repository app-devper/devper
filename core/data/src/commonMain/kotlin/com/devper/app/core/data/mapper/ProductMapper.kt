...
fun ProductPriceResponse.toProductPrice(): ProductPrice = ProductPrice(
    id = id,
    productId = productId,
    unitId = unitId,
    price = price,
...
fun ProductUnitResponse.toProductUnit(): ProductUnit = ProductUnit(
    id = id,
    productId = productId,
    unit = unit,
    costPrice = costPrice,
...
fun ProductStockResponse.toProductStock(): ProductStock = ProductStock(
    id = id,
    productId = productId,
    unitId = unitId,
    quantity = quantity,
